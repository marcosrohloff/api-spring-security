...
import br.com.jwtexemplo.apispringsecurity.entity.*;
import br.com.jwtexemplo.apispringsecurity.util.Util;
...
public class Teste {
    private static final String URL_BASE = "http://localhost:9090/api/v1/venda";
